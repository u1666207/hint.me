                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{route('question.store',['competition'=>$competition->id,'quiz'=>$quiz->id,'type'=>1])}}">
                        ...
                        <div class="form-group{{ $errors->has('body') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea class="form-control" name="body" value="{{ old('body') }}" placeholder="Write question here.." required autofocus>
                                </textarea>
                                @if ($errors->has('body'))
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="input_fields_wrap">
                                    <button class="add_field_button">Add Option</button>
                                   
                                    <input id="options[]" type="text" name="options[]" class="form-control" placeholder="Add false answer option">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        var wrapper2       = $(".input_hints_wrap"); //Fields wrapper2
